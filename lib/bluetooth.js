 ...
 * @param info {object} - object containgin the device informations.
 * @param info.address {string} - the bluetooth device address.
 * @param info.name {string} - the bluetooth device name.
 */
/**
 * Discover wearable kits.
 * @param {discoverCallback} discoverCallback - callback that will return the infomation about the wearables.
 */
Wearable.prototype.discover = function (discoverCallback) {
  var _this = this;
